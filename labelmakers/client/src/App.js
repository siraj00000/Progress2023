...
const EditWarranty = lazy(() => import('./pages/UserPanel/WarrantyRegistration/edit_warranty'));
const RequestHelp = lazy(() => import('./pages/UserPanel/RequestHelp'));
          ...
          <Routes>
            ...
            <Route path='/' element={<UserPanelLayout />}>
              ...
              <Route path='/:type/:dsN' element={<Outlet />}>
                ...
                <Route path='edit-register-warranty' element={<EditWarranty />} />
