...
const UpdateProduct = () => {
    ...
    const [one_click_reorder_feature, setOneClickReorder] = useState(data.one_click_reorder_feature);
    const [reorder_link, setReOrderLink] = useState(data.reorder_link);
    ...
    const updateProductToDB = e => {
        ...
        try {
            ...
            const reqBody = {
                carousel_headings, carousel_text, product_description, survey_feature, survey_link, one_click_reorder_feature,
                reorder_link, videoURL, emptyVideo
            };
