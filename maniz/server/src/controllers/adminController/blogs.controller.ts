...
class BlogController {
    ...
    public async fetchLatestBlogs(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
    ...
    public async fetchBlogById(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
    ...
    public async deleteBlogById(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const blogId = req.params.id;
